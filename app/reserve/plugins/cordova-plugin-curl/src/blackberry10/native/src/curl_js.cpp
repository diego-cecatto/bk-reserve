 ...
 * Default constructor.
 */
CurlJS::CurlJS(const std::string& id) :
		m_id(id) {
  m_curlmgr = new webworks::CurlNDK(this);
}
 ...
 */
string CurlJS::InvokeMethod(const string& command) {
...
void CurlJS::NotifyEvent(const std::string& event) {
